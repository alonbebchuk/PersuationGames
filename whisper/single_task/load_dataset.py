...
def load_dataset(args: Any, tokenizer: WhisperTokenizer, mode: str) -> Dataset:
    all_id, all_audio_path, all_start_sample, all_end_sample, all_label, all_input_ids, all_input_mask = [], [], [], [], [], [], []
    ...
    for game in games:
        ...
        for i, record in enumerate(dialogues):
            ...
            tokens = prompt_builder.get_strategy_prompt_tokens(args.strategy, context, utterance_tokens)
