...
\begin{tikzpicture}[
    ...
    % Title
    \node[font=\large\bfseries] (title) at (9,6) {Whisper Projection Strategy Classification Models};
    ...
    \node[moduleBox, right=1.5cm of dropout] (classify) {Binary Classification Head};
